...
with SQLite() as db:
    db.create_table("users", {"seq": "INTEGER PRIMARY KEY AUTOINCREMENT", "id": "TEXT UNIQUE NOT NULL", "username": "TEXT UNIQUE NOT NULL", "display_name": "TEXT", "pfp": "TEXT", "passkey": "TEXT NOT NULL", "public_key": "TEXT NOT NULL", "created_at": "INTEGER NOT NULL", "status": "TEXT NOT NULL DEFAULT 'online'", "last_seen": "INTEGER", "share_last_seen": "INTEGER NOT NULL DEFAULT 1", "share_typing": "INTEGER NOT NULL DEFAULT 1", "is_bot": "INTEGER NOT NULL DEFAULT 0", "owner_id": "TEXT", "bot_private": "INTEGER DEFAULT 1", "FOREIGN KEY (pfp)": "REFERENCES files (id) ON DELETE SET NULL", "FOREIGN KEY (owner_id)": "REFERENCES users (id) ON DELETE CASCADE"})
